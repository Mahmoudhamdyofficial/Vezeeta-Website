        ...
        <Col md={6}>
          <div className="sign-up-form">
            ...
            <Form onSubmit={handleSignup}>
              ...
              <div className="formName">
                <Form.Label>
                  clinic location <span className="star">*</span>
                </Form.Label>
                <input
                  className="formControl"
                  type="clinic"
              ...
              <div className="formName">
                <Form.Label>
                  Scientific qualifications <span className="star">*</span>
                </Form.Label>
                <input
                  className="formControl"
                  type="text"
              ...
              <div className="formName">
                <Form.Label>
                  Wating Time with miunites <span className="star">*</span>
                </Form.Label>
                <input
                  className="formControl"
                  type="number"
                  ...
                  value={Wating}
                  onChange={(e) => setWating(e.target.value)}
                  required
                />
              </div>
              <br />
