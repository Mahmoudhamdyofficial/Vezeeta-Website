          ...
          <div className="col-3-5 rounded-2 overflow-hidden bg-white mb-5 px-0">
            ...
            <div className="row justify-content-center mt-4">
              <div className="col-9 text-muted">
                {" "}
                Mobile or Email<span className="star">*</span>
                <input
                  className="d-block w-100 log-input"
                  type="email"
            ...
            <div className="row justify-content-center mt-4">
              <div className="col-9 d-flex">
                <div className="w-50">
                  ...
                  <label className="chk-label" htmlFor="chk">
                    {" "}
                    Remember Me{" "}
                  </label>
                </div>
            ...
            <div className="row mt-4 justify-content-center">
              <div className="col-6 d-flex new-user">
                ...
                <div className="w-50">
                  <a className="text-muted fw-semibold" href="/signUp">
                    Sign Up
                  </a>
                </div>
              </div>
