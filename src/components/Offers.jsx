    ...
    <div className="slider-containerMain">
      <div className={styles['slider-container']}>
        ...
        <div className="d-flex justify-content-between p-4">
          <h1 style={{ fontWeight: 650, color: "grey" }}>{language == "English" ? Strings.offers.top.en : Strings.offers.top.ar}</h1>
          <h1><a href="#" style={{ fontSize: 16 }}>{language == "English" ? Strings.offers.all.en : Strings.offers.all.ar} <i className="fa-solid fa-play text-danger" /></a></h1>
        </div>
